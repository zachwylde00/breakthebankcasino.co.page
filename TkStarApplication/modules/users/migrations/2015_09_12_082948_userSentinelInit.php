...
class UserSentinelInit extends Migration {
     ...
     */
    public function up() {
        Capsule::schema()->create('activations', function (Blueprint $table) {
            $table->increments('id');
        ...
        Capsule::schema()->create('role_users', function (Blueprint $table) {
            $table->integer('user_id')->unsigned();
        ...
        Capsule::schema()->create('throttle', function (Blueprint $table) {
            $table->increments('id');
