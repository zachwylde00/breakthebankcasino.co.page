						...
						<li>
							<div class="col-lg-3">
								...
								<div style="margin-top: 10px !important;" class="sidebar-desktop-features">
									...
									<a href="{site_url}casino/plinko"><img class="home-game-iname" src="{site_url}casino/templates/images/logoes/earth_dice.jpg"></a>
									<a href="{site_url}casino/craps"><img class="home-game-iname" src="{site_url}casino/templates/images/logoes/ball_basket.jpg"></a>
