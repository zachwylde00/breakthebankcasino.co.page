<?php
/* Smarty version 3.1.31, created on 2020-02-22 21:19:41
  from "C:\laragon\www\gang4bet\themes\default\TkStarBet2018\modules\bets\moreBets.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5e5169b52e7701_69083067',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3e721f875246bc6a70d5816dc1591dcb0c59217f' => 
    array (
      0 => 'C:\\laragon\\www\\gang4bet\\themes\\default\\TkStarBet2018\\modules\\bets\\moreBets.tpl',
      1 => 1582393741,
      2 => 'file',
    ),
  ),
...
function content_5e5169b52e7701_69083067 (Smarty_Internal_Template $_smarty_tpl) {
							...
							<div class="col-lg-3">
								<div class="stream-bar" style="margin-top: 10px !important;">
									...
									<div class="title" align="center">
										...
										<div data="2" style="width: 50% !important;" class="stream-tab-event  -2 left double-tab tab-border">پخش زنده بازی <div class="symbol" style="display: none;transform: translate(50%,-4px);"><span class="fa fa-caret-up"></span></div></div>
										<?php }?>
										<div class="clear"></div>					
									</div>
...
>
									...
									<?php echo '</script'; ?>
>
									<div id="stream-type-1" class="stream-container"><div style="text-align: center !important; color: #FFCB39 !important; font-size: 13px !important; padding: 20px !important;">تنها بازی های زنده دارای گرافیک زنده هستند</div></div>
									<div id="stream-type-2" class="stream-container" style="display: none;"><div style="text-align: center !important; color: #FFCB39 !important; font-size: 13px !important; padding: 20px !important;">تنها بازی های زنده دارای پخش زنده بازی هستند</div></div>
									<?php }?>
								</div>
...
casino/crash"><img class="home-game-iname" src="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/templates/images/logoes/crash1.jpg"></a>
									<a href="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/baccarat"><img class="home-game-iname" src="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/templates/images/logoes/baccarat1.jpg"></a>
									<a href="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/blackjack"><img class="home-game-iname" src="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/templates/images/logoes/blackjack1.jpg"></a>
									<a href="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/royal_roulette"><img class="home-game-iname" src="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/templates/images/logoes/roulette1.jpg"></a>
									<a href="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/seven_clubs"><img class="home-game-iname" src="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/templates/images/logoes/pasur1.jpg"></a>
									<a href="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/two_verdicts"><img class="home-game-iname" src="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/templates/images/logoes/court_piece1.jpg"></a>
									<a href="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/plinko"><img class="home-game-iname" src="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/templates/images/logoes/earth_dice.jpg"></a>
									<a href="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/craps"><img class="home-game-iname" src="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/templates/images/logoes/ball_basket.jpg"></a>
									<a href="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/fortune_wheel"><img class="home-game-iname" src="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/templates/images/logoes/fortune_wheel1.jpg"></a>
									<a href="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
casino/high_low"><img class="home-game-iname" src="<?php echo smarty_function_site_url(array(),$_smarty_tpl);?>
...
">
								<div class="event-container" style="margin-top: 10px !important;">
									<div class="center border info football" >
										<div class="title title-bg">در حال بارگذاری...</div>
...
/icons/soccer/corner.svg" /></td>
													...
													<tbody>
														<tr>
															<td style="padding: 10px !important; border-top: 2px solid #062649 !important; cursor: auto !important;" colspan="3"><div class="away-team"></div></td>
															<td style="padding: 10px !important; border-top: 2px solid #062649 !important; cursor: auto !important;" class="hidden-xs home-table-rank"></td>
															<td style="padding: 10px !important; border-top: 2px solid #062649 !important; cursor: auto !important;" class="hidden-xs home-formation"></td>
															<td style="padding: 10px !important; border-top: 2px solid #062649 !important; cursor: auto !important;" class="home-penalties"></td>
															<td style="padding: 10px !important; border-top: 2px solid #062649 !important; cursor: auto !important;" class="home-corners"></td>
														</tr>
														<tr>
												...
												<table class="table no-hover" style="margin-bottom: 10px !important;">
													<tbody>
														<tr>
															<td style="padding: 10px !important; border-top: none !important; cursor: auto !important; border-left: 2px solid #062649 !important;" class="hidden-xs" rowspan="2">وضعیت آب و هوا</td>
														...
														<tr>
															<td style="padding: 10px !important; border-top: 2px solid #062649 !important; cursor: auto !important;" class="weather-icon"></td>
															<td style="padding: 10px !important; border-top: 2px solid #062649 !important; cursor: auto !important;" class="weather-temperature"></td>
															<td style="padding: 10px !important; border-top: 2px solid #062649 !important; cursor: auto !important;" class="weather-wind"></td>
														</tr>
													</tbody>
												</table>
												...
												<table class="table no-hover" style="margin-bottom: 0 !important;">
													<tbody>
														<tr>
															<td style="padding: 10px !important; border-top: none !important; cursor: auto !important;border-left: 2px solid #062649 !important;" class="hidden-xs" rowspan="2">مشخصات استادیوم</td>
														...
														<tr>
															<td style="padding: 10px !important; border-top: 2px solid #062649 !important; cursor: auto !important;" class="venue-name"></td>
															<td style="padding: 10px !important; border-top: 2px solid #062649 !important; cursor: auto !important;" class="venue-city"></td>
															<td style="padding: 10px !important; border-top: 2px solid #062649 !important; cursor: auto !important;" class="venue-capacity"></td>
														</tr>
													</tbody>
												</table>
											</div>
											<div class="soccer-game-details-error" style="display: none;"></div>
											<div class="soccer-game-details-loader"><i class="fa m10 fa-5x fa-spinner fa-pulse" style="color:#FFCB39;"></i></div>
										</div>
									</div>
									<div class="clear"></div>
								...
								<div style="margin-top: 10px !important;">
									<table class="bets-table user-bets" >
										<tbody>
											...
											<tr>
												<td style="background-color: #062649 !important;">
													<div class="no-exisitings-bet" style="color:#FFCB39;">برای پیش بینی، ضریب بازی مورد نظر خود را انتخاب کنید</div>
...
/images/support_online.jpg" class="img-responsive img-thumbnail" style="margin-top: 10px !important; max-width: 100% !important; width: 100% !important;" /></a></div>
							</div>
						</li>
					</ul>
				</div>
