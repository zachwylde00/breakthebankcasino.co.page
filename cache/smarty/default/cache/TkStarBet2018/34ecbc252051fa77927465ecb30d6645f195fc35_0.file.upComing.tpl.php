<?php
/* Smarty version 3.1.31, created on 2018-10-25 17:18:08
  from "/home/betpack/domains/betpack.cf/public_html/themes/default/TkStarBet2018/modules/bets/upComing.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5bd1c998f2f117_87714910',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '34ecbc252051fa77927465ecb30d6645f195fc35' => 
    array (
      0 => '/home/betpack/domains/betpack.cf/public_html/themes/default/TkStarBet2018/modules/bets/upComing.tpl',
      1 => 1539617510,
      2 => 'file',
    ),
  ),
...
function content_5bd1c998f2f117_87714910 (Smarty_Internal_Template $_smarty_tpl) {
...
if (!is_callable('smarty_function_jdate')) require_once '/home/betpack/domains/betpack.cf/public_html/TkStarApplication/smarty/plugins/function.jdate.php';
if (!is_callable('smarty_modifier_fa')) require_once '/home/betpack/domains/betpack.cf/public_html/TkStarApplication/smarty/plugins/modifier.fa.php';
if (!is_callable('smarty_function_searchArray')) require_once '/home/betpack/domains/betpack.cf/public_html/TkStarApplication/smarty/plugins/function.searchArray.php';
if (!is_callable('smarty_modifier_con')) require_once '/home/betpack/domains/betpack.cf/public_html/TkStarApplication/smarty/plugins/modifier.con.php';
if (!is_callable('smarty_function_assets_url')) require_once '/home/betpack/domains/betpack.cf/public_html/TkStarApplication/smarty/plugins/function.assets_url.php';
?>
<div>
	<div class="cell">
		<div class="container">
...
?>
															<?php ob_start();
echo $_smarty_tpl->tpl_vars['match']->value->time->starting_at->date_time;
$_prefixVariable1=ob_get_clean();
if (Miladr\Jalali\jDateTime::date('Y/m/d H:i:s',strtotime(DateTime::createFromFormat('H:i:s',$_prefixVariable1))) < Miladr\Jalali\jDateTime::date('Y/m/d H:i:s',time())) {
continue 1;
}?>
															<?php ob_start();
...
$_smarty_tpl->_assignInScope('myArray', $_smarty_tpl->tpl_vars['match']->value->odds->data[0]->bookmaker->data[$_prefixVariable2]);
?>
...
echo smarty_modifier_con($_smarty_tpl->tpl_vars['match']->value->id,'-',$_smarty_tpl->tpl_vars['myArray']->value->id,'-1x2-',$_prefixVariable4);?>
...
if ($_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable5]->value == '') {?> passive-ma<?php }?>"><span><?php ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'1','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable6=ob_get_clean();
if (empty($_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable6]->value)) {?><text style="color: white !important;">...</text><?php } else {
ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'1','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable7=ob_get_clean();
echo $_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable7]->value;
}?></span></a>
																		<a href="javascript:;" data-eventid="<?php echo $_smarty_tpl->tpl_vars['match']->value->id;?>
" data-runnerid="<?php ob_start();
...
ob_start();
echo $_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable8]->label;
$_prefixVariable9=ob_get_clean();
echo smarty_modifier_con($_smarty_tpl->tpl_vars['match']->value->id,'-',$_smarty_tpl->tpl_vars['myArray']->value->id,'-1x2-',$_prefixVariable9);?>
" data-pick="مساوی" data-points="" class="inplaybtn odd-rate odd-main-button odd-link<?php ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'X','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable10=ob_get_clean();
if ($_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable10]->value == '') {?> passive-ma<?php }?>"><span><?php ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'X','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable11=ob_get_clean();
if (empty($_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable11]->value)) {?><text style="color: white !important;">...</text><?php } else {
ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'X','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable12=ob_get_clean();
echo $_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable12]->value;
}?></span></a>
																		<a href="javascript:;" data-eventid="<?php echo $_smarty_tpl->tpl_vars['match']->value->id;?>
" data-runnerid="<?php ob_start();
...
ob_start();
echo $_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable13]->label;
$_prefixVariable14=ob_get_clean();
echo smarty_modifier_con($_smarty_tpl->tpl_vars['match']->value->id,'-',$_smarty_tpl->tpl_vars['myArray']->value->id,'-1x2-',$_prefixVariable14);?>
" data-pick="<?php echo $_smarty_tpl->tpl_vars['match']->value->visitorTeam->data->name;?>
" data-points="" class="inplaybtn odd-rate odd-main-button odd-link<?php ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'2','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable15=ob_get_clean();
if ($_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable15]->value == '') {?> passive-ma<?php }?>"><span><?php ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'2','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable16=ob_get_clean();
if (empty($_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable16]->value)) {?><text style="color: white !important;">...</text><?php } else {
ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'2','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable17=ob_get_clean();
echo $_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable17]->value;
}?></span></a>
																	</div>
																</span>
