<?php
/* Smarty version 3.1.31, created on 2020-01-25 14:13:00
  from "/home/gang4bet/public_html/themes/default/TkStarBet2018/modules/contacts/view_ticket.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5e2c1bb495a7a5_03407297',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b59cddabe3625589c169e4e6483c6e7b1054efe6' => 
    array (
      0 => '/home/gang4bet/public_html/themes/default/TkStarBet2018/modules/contacts/view_ticket.tpl',
      1 => 1545587702,
      2 => 'file',
    ),
  ),
...
function content_5e2c1bb495a7a5_03407297 (Smarty_Internal_Template $_smarty_tpl) {
                        ...
                        <div class="row">
                            <div class="col-lg-12" style="background-color: #333333 !important; text-align: right !important; color: #ffffff !important; padding: 10px 25px 20px 10px !important;">
								<ul>
									...
									<li><b>وضعیت تیکت :</b> <?php if ($_smarty_tpl->tpl_vars['ticket']->value->status == 2) {?><span class="label label-success" style="width: 200px !important; display: inline-block !important; color: white !important;">پاسخ داده شده</span><?php } elseif ($_smarty_tpl->tpl_vars['ticket']->value->status == 0) {?><span class="label label-warning" style="width: 200px !important; display: inline-block !important; color: white !important;">منتظر پاسخ</span><?php } else { ?><span class="label label-default" style="width: 200px !important; display: inline-block !important; color: white !important;">در حال بررسی</span><?php }?></li>
								</ul>
							</div>
                        </div>
                    </header>
...
?>
					<div class="row">
						<?php if ($_smarty_tpl->tpl_vars['val']->value['user_id'] != $_smarty_tpl->tpl_vars['logged_in_user_id']->value) {?><div class="col-lg-9" style="margin-top: calc(3.3%) !important; text-align: justify !important; direction: rtl !important;" align="left"><div class="bubblereply"><?php echo $_smarty_tpl->tpl_vars['val']->value->content;?>
</div></div><?php }?>
						<div class="col-lg-3">
							<div class="row">
...
/images/<?php if ($_smarty_tpl->tpl_vars['val']->value['user_id'] == $_smarty_tpl->tpl_vars['logged_in_user_id']->value) {?>user<?php } elseif ($_smarty_tpl->tpl_vars['val']->value['user_id'] != $_smarty_tpl->tpl_vars['logged_in_user_id']->value) {?>support<?php }?>.png" /></div>
								<div class="col-md-6 col-sm-6 col-xs-6"><div style="margin-top: 25px !important;"><?php echo smarty_function_jdate(array('format'=>'l d F Y','date'=>$_smarty_tpl->tpl_vars['val']->value->created_at),$_smarty_tpl);?>
