<?php
/* Smarty version 3.1.31, created on 2020-03-01 19:51:40
  from "C:\laragon\www\gang4bet\themes\default\TkStarBet2018\modules\bets\upComing.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5e5c124c66dad4_91583247',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4cccb17db27cfe90ed264e8d9922d2512a1d5ff7' => 
    array (
      0 => 'C:\\laragon\\www\\gang4bet\\themes\\default\\TkStarBet2018\\modules\\bets\\upComing.tpl',
      1 => 1583015206,
      2 => 'file',
    ),
  ),
...
function content_5e5c124c66dad4_91583247 (Smarty_Internal_Template $_smarty_tpl) {
...
if (!is_callable('smarty_function_searchArray')) require_once 'C:\\laragon\\www\\gang4bet\\TkStarApplication\\smarty\\plugins\\function.searchArray.php';
...
?>
    															<?php $_smarty_tpl->_assignInScope('myArray', isset($_smarty_tpl->tpl_vars['match']->value->odds->data[1]) && $_smarty_tpl->tpl_vars['match']->value->odds->data[1]->name == '3Way Result' ? $_smarty_tpl->tpl_vars['match']->value->odds->data[1]->bookmaker->data[0] : $_smarty_tpl->tpl_vars['match']->value->odds->data[0]->bookmaker->data[0]);
?>
    															<?php if (empty($_smarty_tpl->tpl_vars['myArray']->value) || (!is_array($_smarty_tpl->tpl_vars['myArray']->value) && !is_object($_smarty_tpl->tpl_vars['myArray']->value))) {?>
    															    <?php
continue 1;?>
    															<?php }?>
...
ob_start();
echo $_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable1]->label;
$_prefixVariable2=ob_get_clean();
echo smarty_modifier_con($_smarty_tpl->tpl_vars['match']->value->id,'-',$_smarty_tpl->tpl_vars['myArray']->value->id,'-1x2-',$_prefixVariable2);?>
...
if ($_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable3]->value == '') {?> passive-ma<?php }?>"><span><?php ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'1','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable4=ob_get_clean();
if (empty($_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable4]->value)) {?><text style="color: white !important;">...</text><?php } else {
ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'1','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
...
ob_start();
echo $_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable6]->label;
$_prefixVariable7=ob_get_clean();
echo smarty_modifier_con($_smarty_tpl->tpl_vars['match']->value->id,'-',$_smarty_tpl->tpl_vars['myArray']->value->id,'-1x2-',$_prefixVariable7);?>
" data-pick="مساوی" data-points="" class="inplaybtn odd-rate odd-main-button odd-link<?php ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'X','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable8=ob_get_clean();
if ($_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable8]->value == '') {?> passive-ma<?php }?>"><span><?php ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'X','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable9=ob_get_clean();
if (empty($_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable9]->value)) {?><text style="color: white !important;">...</text><?php } else {
ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'X','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable10=ob_get_clean();
echo $_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable10]->value;
}?></span></a>
    																		<a href="javascript:;" data-eventid="<?php echo $_smarty_tpl->tpl_vars['match']->value->id;?>
" data-runnerid="<?php ob_start();
...
ob_start();
echo $_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable11]->label;
$_prefixVariable12=ob_get_clean();
echo smarty_modifier_con($_smarty_tpl->tpl_vars['match']->value->id,'-',$_smarty_tpl->tpl_vars['myArray']->value->id,'-1x2-',$_prefixVariable12);?>
" data-pick="<?php echo $_smarty_tpl->tpl_vars['match']->value->visitorTeam->data->name;?>
" data-points="" class="inplaybtn odd-rate odd-main-button odd-link<?php ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'2','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable13=ob_get_clean();
if ($_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable13]->value == '') {?> passive-ma<?php }?>"><span><?php ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'2','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable14=ob_get_clean();
if (empty($_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable14]->value)) {?><text style="color: white !important;">...</text><?php } else {
ob_start();
echo smarty_function_searchArray(array('key'=>'label','val'=>'2','array'=>$_smarty_tpl->tpl_vars['myArray']->value->odds->data),$_smarty_tpl);
$_prefixVariable15=ob_get_clean();
echo $_smarty_tpl->tpl_vars['myArray']->value->odds->data[$_prefixVariable15]->value;
}?></span></a>
    																	</div>
    																</span>
